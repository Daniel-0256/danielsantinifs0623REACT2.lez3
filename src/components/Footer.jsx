function Footer() {
    return (
        <footer className="bg-dark">
            ...
            <div className="col-6 offset-3 pt-3 pb-3">
              <div className="row">
              ...
              <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 text-left">
                <div className="col">
                  <div className="row">
              ...
              <div className="row">
                <div className="col col-12 text-left mb-2">
                  <button
                    id="service"
                    type="button"
                    className="btn btn-sm footer-button rounded-0 mt-3 text-light">
                    Service Code
                  </button>
                </div>
              </div>
              <div className="row">
                <div className="col col-12 text-left mb-2 mt-2 copyright text-light">
